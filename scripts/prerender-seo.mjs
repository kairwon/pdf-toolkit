...
const pages = {
  ...
  '/images-to-pdf': ['Convert Images to One PDF Without Uploading | Lab of PDF', 'Combine JPEG, PNG, or WebP images into an ordered A4, Letter, or image-sized PDF. Rotate photos and create the file privately in your browser.', 'Images to PDF'],
...
await writeFile(sitemapUrl, sitemap
  .replace(/<lastmod>[^<]+<\/lastmod>/g, '<lastmod>2026-08-13</lastmod>')
  .replace(/<loc>([^<]+)<\/loc>(?!<lastmod>)/g, '<loc>$1</loc><lastmod>2026-08-13</lastmod>'))
