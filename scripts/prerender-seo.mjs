...
const pages = {
  ...
  '/word-to-pdf': ['LibreOffice Word to PDF Converter | Lab of PDF', 'Convert DOC or DOCX to PDF with the LibreOffice Writer engine, then preview the actual finished PDF. Temporary files are deleted after conversion.', 'Word to PDF'],
