  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-content">
        ...
        <section><h2>7. Legal rights</h2><p>Depending on where you live, you may have rights to access, correct, delete, restrict, or object to processing of personal information received by the website. Because PDF contents are not received, Lab of PDF cannot retrieve or delete documents that never left your device.</p></section>
        <section><h2>8. Children</h2><p>The service is a general-purpose document utility and is not directed to children under 13. Do not use it to submit personal information to us about a child.</p></section>
        <section><h2>9. Contact</h2><p>Questions and privacy requests can be sent to <a href="mailto:labofpdf@gmail.com">labofpdf@gmail.com</a>. The site operator should add its legal name and mailing address here before commercial launch if required by its jurisdiction or advertising partner.</p></section>
      </div>
    </div>
  )
}
