  ...
  return (
    <div className="min-h-screen bg-scene flex flex-col">
      ...
      <footer className="border-t border-gray-200 dark:border-gray-700/30 bg-white/50 dark:bg-black/10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400 dark:text-gray-500">
